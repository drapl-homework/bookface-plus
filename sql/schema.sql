...
-- 用户账户样例
insert into `account` values ('test', "测试用户甲", 'test', "男", 'test@pku.edu.cn', 1, '1992-3-5');
insert into `account` values ('test2', "测试用户乙", 'test2', "女", 'test2@pku.edu.cn', 2, '1992-4-5');
insert into `account` values ('test3', "测试用户丙", 'test3', "男", 'test3@pku.edu.cn', 3, '1992-5-5');
insert into `account` values ('test4', "测试用户丁", 'test4', "男", 'test4@pku.edu.cn', 4, '1993-5-5');
...
create table if not exists `group` (
	...
	group_intro char(255) not null,
	group_avatar integer,
	owner char(32) not null,
	FOREIGN KEY(owner) REFERENCES account(username)
) default charset=utf8;
insert into `group` values('1', '数据库概论', '数据库概论讨论组', 1, 'test');
insert into `group` values('1', '计算机', '讨论有关计算机的内容', 5, 'test2');
...
insert into `group_member` values('1', 'test3');
insert into `group_member` values('1', 'test2');
insert into `group_member` values('2', 'test1');
insert into `group_member` values('2', 'test4');
